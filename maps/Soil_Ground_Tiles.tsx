...
<tileset version="1.10" tiledversion="1.11.1" name="Soil_Ground_Tiles" tilewidth="16" tileheight="16" tilecount="77" columns="11">
 <image source="../../../../../Downloads/Sprout Lands - Sprites - premium pack/Tilesets/ground tiles/New tiles/Soil_Ground_Tiles.png" width="176" height="112"/>
 <wangsets>
  <wangset name="Soil" type="corner" tile="58">
   <wangcolor name="Soil" color="#edb016" tile="-1" probability="1"/>
   <wangcolor name="Empty" color="#b2b1ac" tile="-1" probability="1"/>
