...
<tileset version="1.10" tiledversion="1.11.1" name="Darker_Soil_Ground_Tiles" tilewidth="16" tileheight="16" tilecount="77" columns="11">
 <image source="../../../../../Downloads/Sprout Lands - Sprites - premium pack/Tilesets/ground tiles/New tiles/Darker_Soil_Ground_Tiles.png" width="176" height="112"/>
 <wangsets>
  <wangset name="Darker soil" type="corner" tile="58">
   <wangcolor name="Soil" color="#b1301c" tile="-1" probability="1"/>
   <wangcolor name="Empty" color="#b0c5ad" tile="-1" probability="1"/>
   <wangtile tileid="0" wangid="0,2,0,1,0,2,0,2"/>
   <wangtile tileid="1" wangid="0,2,0,1,0,1,0,2"/>
   <wangtile tileid="2" wangid="0,2,0,2,0,1,0,2"/>
   <wangtile tileid="9" wangid="0,2,0,1,0,2,0,1"/>
   ...
   <wangtile tileid="20" wangid="0,1,0,2,0,1,0,2"/>
